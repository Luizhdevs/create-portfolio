...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 37 9.9813-0206",
      link: "https://wa.me/5537998130206?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "luizhdevs00@gmail.com",
      link: "mailto:luizhdevs00@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Divinópolis",
      description: "Centro",
      link: "https://www.google.com/maps/place/Divin%C3%B3polis,+MG/@-20.1450179,-44.9005665,15z/data=!4m6!3m5!1s0xa0a5bc241bce2f:0xf7e939bd5077b17d!8m2!3d-20.1435294!4d-44.8904062!16zL20vMDVrdGN6?entry=ttu",
